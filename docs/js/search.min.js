!function () {
    ...
    function g(r, e, o, s) {
        void 0 === e && (e = "");
        var c, e = window.marked.lexer(e), d = window.Docsify.slugify, l = {}, p = "";
        return e.forEach(function (e, n) {
            if ("heading" === e.type && e.depth <= s) {
                ...
                c = t.id ? o.toURL(r, {id: d(t.id)}) : o.toURL(r, {
                    id: d((t = e.text, i = {
                        "&": "&amp;",
                        "<": "&lt;",
                        ">": "&gt;",
        ...
        var e = function (e) {
            ...
            for (var i = 0; i < t.length; i++) !function (e) {
                ...
                d && (a.forEach(function (e) {
                    var n, t = new RegExp(p(e).replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"), "gi"), a = -1, i = -1;
    ...
    $docsify.plugins = [].concat(function (e, n) {
        var t = Docsify.util, a = n.config.search || v;
